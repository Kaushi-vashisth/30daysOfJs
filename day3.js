...
else if (num < 20) console.log("Negative");
else console.log("Zero");// Output-Positive
...
if (a > b) {
    ...
    else console.log("c is greater");//Output-c is greater
}
...
switch (day) {
    ...
    case 7:
        ...
        break;
    default:
        console.log("Invalid day number");//Output-Sunday
...
let x=12;
x%2==0?console.log("even"):console.log("odd");//output =even
...
if ((year % 4 === 0 && year % 100 !== 0) || (year % 400 === 0)) {
    ...
    console.log("non leap year");//Output-leap year
}
